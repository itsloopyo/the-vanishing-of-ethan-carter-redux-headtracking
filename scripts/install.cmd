@echo off
:: ============================================
:: The Vanishing of Ethan Carter Redux Head Tracking - Install
:: ============================================
...
:: --- CONFIG BLOCK ---
set "GAME_ID=ethan-carter-redux"
set "MOD_DISPLAY_NAME=The Vanishing of Ethan Carter Redux Head Tracking"
set "MOD_DLLS=EthanCarterReduxHeadTracking.asi"
set "MOD_INTERNAL_NAME=EthanCarterReduxHeadTracking"
...
set "MOD_CONTROLS=Controls:&echo   End       - Toggle head tracking on/off&echo   Page Up   - Cycle tracking mode: full / rotation only / position only&echo   Page Down - Toggle yaw mode (world-locked / camera-local)&echo   Chords    - Ctrl+Shift+Y = toggle, Ctrl+Shift+G = mode, Ctrl+Shift+H = yaw"
:: --- END CONFIG BLOCK ---
